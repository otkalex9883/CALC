...
from streamlit_date_picker import date_picker  # pip package: streamlit-date-picker

# 서버 측 locale (UI 달력과는 무관하지만, 일부 문자열 포맷에 도움)
try:
...
# date_picker는 날짜를 문자열 또는 date로 반환할 수 있음(패키지 구현에 따라 다름)
picked = date_picker(
    label="제조일자 선택",
    value=st.session_state.date_input,
    locale="ko",            # 한글 로케일(월/요일 한글)
)
